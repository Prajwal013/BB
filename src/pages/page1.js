...
import { incCounter } from "../Redux/increment/themeAction";
  ...
  useEffect(() => {
    fetch(
      process.env.NODE_ENV === "production"
        ? "https://demo.bigbeartech.in//sample-api"
        : "/server/sample-api"
    )
  ...
  return (
    ...
    >
      <section className="toggle" theme-mode={theme}>
        <h1 theme-mode={theme} className="heading">
                  ...
                  <div className="flip-card-inner">
                    ...
                    <div className="flip-card-back">
                      <p className="info-heading">
                        Check the Information of each candidate
                      </p>
                      <Select
